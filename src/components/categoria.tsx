...
SELECT * FROM usuarios WHERE nome = "João Silva";`,
  ...
  },
  {
    ...
    snippets: [
      {
        id: 'sqlite-1',
        title: 'Criar e Conectar ao Banco de Dados',
        description:
          'Abre ou cria um novo arquivo de banco SQLite e entra no shell interativo.',
        language: 'bash',
        code: '# Cria ou abre meu_banco.db\nsqlite3 meu_banco.db\n\n# Dentro do SQLite, você pode começar a digitar comandos SQL.\n# Para sair: .exit ou Ctrl + D',
      },
      {
        id: 'sqlite-2',
        title: 'Criar Tabela e Comentários sobre Estrutura',
        description:
          'Exemplo completo com chave primária, tipos de dados e boas práticas.',
        language: 'sql',
        code: '-- Cria tabela de usuários\nCREATE TABLE usuarios (\n  id INTEGER PRIMARY KEY AUTOINCREMENT, -- Identificador único\n  nome TEXT NOT NULL,                  -- Nome obrigatório\n  email TEXT UNIQUE,                   -- Email exclusivo\n  idade INTEGER DEFAULT 18             -- Valor padrão\n);',
      },
      {
        id: 'sqlite-3',
        title: 'Apagar Tabela ou Coluna',
        description: 'Remoção de estruturas da tabela.',
        language: 'sql',
        code: '-- Apagar tabela inteira (perde todos os dados)\nDROP TABLE IF EXISTS usuarios;\n\n-- SQLite não possui DROP COLUMN diretamente; precisa recriar a tabela.',
      },
      {
        id: 'sqlite-4',
        title: 'Inserir Múltiplos Registros',
        description: 'Adiciona vários dados em uma única instrução.',
        language: 'sql',
        code: 'INSERT INTO usuarios (nome, email, idade) VALUES\n("Ana", "ana@example.com", 20),\n("Bruno", "bruno@example.com", 30),\n("Clara", "clara@example.com", 25);',
      },
      {
        id: 'sqlite-5',
        title: 'SELECT - Todas as Formas Comuns',
        description: 'Consultas básicas e intermediárias agrupadas.',
        language: 'sql',
        code: '-- Seleciona tudo\nSELECT * FROM usuarios;\n\n-- Seleciona colunas específicas\nSELECT nome, idade FROM usuarios;\n\n-- Ordena resultados\nSELECT * FROM usuarios ORDER BY idade DESC;\n\n-- Aplica condição\nSELECT * FROM usuarios WHERE idade >= 25;\n\n-- Limita resultados\nSELECT * FROM usuarios LIMIT 2 OFFSET 1;',
      },
      {
        id: 'sqlite-6',
        title: 'Atualizar e Deletar Registros',
        description: 'Modificação e exclusão baseadas em condições.',
        language: 'sql',
        code: '-- Atualiza nome de um usuário\nUPDATE usuarios SET nome = "Carlos" WHERE id = 2;\n\n-- Deleta usuário com id específico\nDELETE FROM usuarios WHERE id = 3;',
      },
      {
        id: 'sqlite-7',
        title: 'Chaves Primárias e Estrangeiras',
        description:
          'Relacionamentos entre tabelas com restrições de integridade.',
        language: 'sql',
        code: '-- Tabela principal: usuarios\nCREATE TABLE usuarios (\n  id INTEGER PRIMARY KEY,\n  nome TEXT\n);\n\n-- Tabela dependente: pedidos\nCREATE TABLE pedidos (\n  id INTEGER PRIMARY KEY,\n  produto TEXT,\n  usuario_id INTEGER,\n  FOREIGN KEY(usuario_id) REFERENCES usuarios(id)\n);',
      },
      {
        id: 'sqlite-8',
        title: 'JOIN: Unir Tabelas',
        description: 'Consulta que une tabelas relacionadas.',
        language: 'sql',
        code: '-- Mostra produto junto com nome do usuário\nSELECT u.nome, p.produto\nFROM usuarios u\nJOIN pedidos p ON u.id = p.usuario_id;',
      },
      {
        id: 'sqlite-9',
        title: 'Funções Agregadas e GROUP BY',
        description:
          'Utiliza funções como COUNT, AVG, etc. para sumarizar dados.',
        language: 'sql',
        code: '-- Total de usuários\nSELECT COUNT(*) FROM usuarios;\n\n-- Média de idade\nSELECT AVG(idade) FROM usuarios;\n\n-- Agrupando por idade\nSELECT idade, COUNT(*) FROM usuarios GROUP BY idade;',
      },
      {
        id: 'sqlite-10',
        title: 'Filtragem com LIKE, IN, BETWEEN',
        description: 'Combinações de filtros úteis em consultas.',
        language: 'sql',
        code: '-- Emails do domínio example.com\nSELECT * FROM usuarios WHERE email LIKE "%@example.com";\n\n-- Idades específicas\nSELECT * FROM usuarios WHERE idade IN (20, 25);\n\n-- Intervalo de idade\nSELECT * FROM usuarios WHERE idade BETWEEN 18 AND 30;',
      },
      {
        id: 'sqlite-11',
        title: 'HAVING com GROUP BY',
        description: 'Filtra grupos agregados após o agrupamento.',
        language: 'sql',
        code: '-- Apenas grupos com mais de um registro\nSELECT idade, COUNT(*)\nFROM usuarios\nGROUP BY idade\nHAVING COUNT(*) > 1;',
      },
      {
        id: 'sqlite-12',
        title: 'Visualizar Estrutura de Tabela',
        description: 'Exibe colunas e tipos da tabela.',
        language: 'sql',
        code: '.schema usuarios',
      },
      {
        id: 'sqlite-13',
        title: 'Verificar Tabelas Existentes',
        description: 'Consulta o catálogo interno do banco.',
        language: 'sql',
      ...
      },
      {
        id: 'sqlite-14',
        title: 'Criar Índice',
        description: 'Melhora desempenho de consultas específicas.',
        language: 'sql',
      ...
      },
      {
        id: 'sqlite-15',
        title: 'Apagar Índice',
        description: 'Remove índice criado anteriormente.',
        language: 'sql',
        code: 'DROP INDEX IF EXISTS idx_email;',
      },
      {
        id: 'sqlite-16',
        title: 'Exportar para CSV',
        description: 'Gera arquivo com os dados da tabela.',
        language: 'bash',
        code: '.mode csv\n.headers on\n.output usuarios.csv\nSELECT * FROM usuarios;\n.output stdout',
      },
      {
        id: 'sqlite-17',
        title: 'Importar CSV para Tabela',
        description: 'Lê dados de um arquivo CSV para uma tabela já existente.',
        language: 'bash',
        code: '.mode csv\n.import usuarios.csv usuarios',
      },
      {
        id: 'sqlite-18',
        title: 'Triggers: Executar ações automáticas',
        description: 'Define evento automático após operações.',
        language: 'sql',
        code: 'CREATE TRIGGER log_insert\nAFTER INSERT ON usuarios\nBEGIN\n  INSERT INTO log_table (mensagem)\n  VALUES ("Novo usuário adicionado.");\nEND;',
      },
      {
        id: 'sqlite-19',
        title: 'Transações',
        description: 'Agrupamento de operações com possibilidade de rollback.',
        language: 'sql',
        code: 'BEGIN TRANSACTION;\nINSERT INTO usuarios VALUES (NULL, "Lucas", "lucas@example.com", 27);\nUPDATE usuarios SET idade = 28 WHERE nome = "Lucas";\nCOMMIT;',
      },
      {
        id: 'sqlite-20',
        title: 'Funções UDF e Expressões',
        description: 'Utiliza expressões e operadores em consultas.',
        language: 'sql',
        code: 'SELECT nome, idade, idade + 5 AS idade_futura\nFROM usuarios WHERE LENGTH(nome) > 4;',
      },
      {
        id: 'py-1',
