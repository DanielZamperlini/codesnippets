...
SELECT * FROM usuarios WHERE nome = "João Silva";`,
  ...
  },
  {
    ...
    snippets: [
      {
        id: 'sqlite-1',
        title: 'Criar e Conectar ao Banco',
        description: 'Abre ou cria um arquivo .db e entra no shell do SQLite.',
        language: 'bash',
        code: 'sqlite3 meu_banco.db\n\n-- Dentro do shell use .exit para sair',
      },
      {
        id: 'sqlite-2',
        title: 'Criar Tabela de Usuários',
        description:
          'Define estrutura com tipos, chave primária, campo obrigatório e valor padrão.',
        language: 'sql',
      ...
      },
      {
        ...
        description:
          'Remove tabela inteira ou simula exclusão de coluna recriando tabela.',
        language: 'sql',
        code: 'DROP TABLE IF EXISTS usuarios;\n-- SQLite não possui DROP COLUMN diretamente',
      },
      {
        id: 'sqlite-4',
        title: 'Inserir Múltiplos Registros',
        description: 'Adiciona vários usuários com uma única instrução.',
        language: 'sql',
      ...
      },
      {
        ...
        description: 'Seleciona dados com filtros, ordenação e limites.',
        language: 'sql',
      ...
      {
        id: 'sqlite-6',
        title: 'Atualizar e Remover Registros',
        description: 'Modifica dados ou exclui entradas usando condições.',
        language: 'sql',
        code: 'UPDATE usuarios SET nome = "Carlos" WHERE id = 2;\nDELETE FROM usuarios WHERE id = 3;',
      },
      {
        id: 'sqlite-7',
        title: 'Chaves Primária e Estrangeira',
        description:
          'Relaciona duas tabelas com restrição de integridade referencial.',
        language: 'sql',
      ...
      },
      {
        ...
        description: 'Consulta combinando dados entre usuários e pedidos.',
        language: 'sql',
      ...
      },
      {
        ...
        description: 'Funções como COUNT, AVG e agrupamento com GROUP BY.',
        language: 'sql',
      ...
      },
      {
        ...
        description: 'Busca avançada com padrões e listas de valores.',
        language: 'sql',
      ...
      },
      {
        ...
        description: 'Filtra resultados agregados após agrupamento.',
        language: 'sql',
        code: 'SELECT idade, COUNT(*) FROM usuarios\nGROUP BY idade\nHAVING COUNT(*) > 1;',
      },
      {
        id: 'sqlite-12',
        title: 'Visualizar Estrutura da Tabela',
        description: 'Exibe definição SQL da tabela usando .schema.',
        language: 'sql',
      ...
      },
      {
        ...
        description: 'Lista as tabelas presentes no banco.',
        language: 'sql',
      ...
      },
      {
        id: 'sqlite-14',
        title: 'Criar Índice',
        description: 'Melhora performance de consultas em campos específicos.',
        language: 'sql',
      ...
      },
      {
        id: 'sqlite-15',
        title: 'Apagar Índice',
        description: 'Remove índice se existir.',
        language: 'sql',
      ...
      },
      {
        ...
        description: 'Gera arquivo com os dados para uso externo.',
        language: 'bash',
        code: '.mode csv\n.headers on\n.output usuarios.csv\nSELECT * FROM usuarios;\n.output stdout',
      },
      {
        ...
        description: 'Lê dados de um arquivo para a tabela.',
        language: 'bash',
      ...
      },
      {
        id: 'sqlite-18',
        title: 'Triggers',
        description: 'Executa ações automáticas após eventos.',
        language: 'sql',
      ...
      },
      {
        id: 'sqlite-19',
        title: 'Transações',
        description: 'Agrupa instruções com controle de execução.',
        language: 'sql',
        code: 'BEGIN TRANSACTION;\nINSERT INTO usuarios VALUES (NULL, "Lucas", "lucas@example.com", 27);\nUPDATE usuarios SET idade = 28 WHERE nome = "Lucas";\nCOMMIT;',
      },
      {
        id: 'sqlite-20',
        title: 'Expressões e Funções',
        description: 'Consulta com operadores e funções nativas.',
        language: 'sql',
